...
local function MakeEnrageable(inst)
    inst.components.health:SetMaxHealth(TUNING.DEERCLOPS_HEALTH * TUNING.DSTU.DEERCLOPS_MUTATIONS_HEALTH)
...
local function MakeStrong(inst)
    inst.components.health:SetMaxHealth((TUNING.DEERCLOPS_HEALTH * 1.125) * TUNING.DSTU.DEERCLOPS_MUTATIONS_HEALTH)
...
local function MakeIcey(inst)
    inst.components.health:SetMaxHealth((TUNING.DEERCLOPS_HEALTH * 0.875) * TUNING.DSTU.DEERCLOPS_MUTATIONS_HEALTH)
