...
local states=
{
	...
	State{
		...
		onenter = function(inst)
			...
			inst.AnimState:SetBuild(IsSpecialEventActive(SPECIAL_EVENTS.WINTERS_FEAST) and "mossling_angry_build" or "mossling_yule_angry_build")
...
return StateGraph("mothermossling", states, events, "idle", actionhandlers)
