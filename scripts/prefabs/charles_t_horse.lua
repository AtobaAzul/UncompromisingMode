        ...
        if owner.components.locomotor.wantstomoveforward then
			if inst.ringalingtask == nil then
				inst.ringalingtask = inst:DoPeriodicTask(.8, function(inst)
					...
					if owner ~= nil and owner:IsValid() and wardrobe ~= nil and wardrobe:IsValid() then
					...
					if wixie_clock ~= nil and inst.final_code_ready and distsq ~= nil and (inst.code2 == 0 and distsq < 80 or inst.code2 > 0 and distsq < 4000) then
						...
						elseif point == "E" and (inst.code2 == 1 or inst.code2 == 7) then
							inst.code2 = inst.code2 + 1
						elseif point == "S" and (inst.code2 == 2 or inst.code2 == 3 or inst.code2 == 6) then
							inst.code2 = inst.code2 + 1
...
local function realfn()
    ...
    inst:AddComponent("inventoryitem")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/the_real_charles_t_horse.xml"
