...
local function tree_fn()
    ...
    inst.components.beard.prize = "twigs"
...
return Prefab("cinnamon_tree", tree_fn, assets, prefabs_tree),
    Prefab("cinnamon_tree_burnt", burnt_fn, assets, prefabs_burnt),
    Prefab("cinnamon_tree_stump", stump_fn, assets, prefabs_stump)
