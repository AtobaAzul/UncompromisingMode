...
if #TheSim:FindEntities(xi,0,zi,1.5,{"webbedcreature"}) == 0 and #TheSim:FindEntities(xi,0,zi,3,{"webbedcreature"}) < 2 and #TheSim:FindEntities(xi,0,zi,5,{"webbedcreature"}) < 6 then
...
local xi=x+math.random(-12,12)
local zi=z+math.random(-12,12)
if #TheSim:FindEntities(xi,0,zi,1.5,{"webbedcreature","webdecor"}) == 0 and #TheSim:FindEntities(xi,0,zi,3,{"webbedcreature","webdecor"}) < 2 and #TheSim:FindEntities(xi,0,zi,5,{"webbedcreature","webdecor"}) < 6 and math.abs(xi) > 6 and math.abs(zi) > 6 then
