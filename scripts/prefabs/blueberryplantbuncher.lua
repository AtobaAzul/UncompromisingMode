...
--Shadow Spawning Function, for now (which was modified to spawn blueberries lololololol)
...
x = x + math.random()+math.random()+0.35
z = z - 0.5 +math.random()
end
x = x - 3 * math.random()- 3 * math.random() - 0.75
z = z + math.random()+math.random()+0.35
end
inst:Remove()
end
...
return Prefab("blueberryplantbuncher", makefn, assets)
