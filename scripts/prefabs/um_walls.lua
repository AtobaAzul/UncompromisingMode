...
function MakeWallType(data)
    ...
    local function itemfn()
        ...
        inst.AnimState:SetBuild("wall_stone")--inst.AnimState:SetBuild("wall_"..data.name)
    ...
    return Prefab("wall_"..data.name, fn, assets, prefabs),
        Prefab("wall_"..data.name.."_item", itemfn, assets, { "wall_stone", "wall_stone_item_placer" }),
        MakePlacer("wall_"..data.name.."_item_placer", "wall", "wall_stone", "half", false, false, true, nil, nil, "eight")
	
	--[[Prefab("wall_"..data.name, fn, assets, prefabs),
...
local walldata =
{
    { name = "ghost" , material = "ghost", tags = { "stone", "moonrock" }, loot = "moonglass",   maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_stone" },
}
