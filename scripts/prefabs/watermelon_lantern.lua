...
local function fn()
    ...
    inst.AnimState:SetBuild("watermelon_lantern")
    inst.AnimState:PlayAnimation("idle_day")
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/watermelon_lantern.xml"
...
return Prefab("watermelon_lantern", fn, assets, prefabs)
