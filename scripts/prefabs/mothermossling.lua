...
local function fn()
    ...
    inst.AnimState:SetBuild(IsSpecialEventActive(SPECIAL_EVENTS.WINTERS_FEAST) and "mossling_build" or "mossling_yule_build")
    ...
    inst.components.herdmember.herdprefab = "mothergooseegg"
    ...
    inst:SetStateGraph("SGmothermossling")
    inst:SetBrain(brain)
...
return Prefab("mothermossling", fn, assets, prefabs)
