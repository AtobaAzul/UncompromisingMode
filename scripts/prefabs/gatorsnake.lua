...
local function fnhead()
    ...
    inst.AnimState:SetBank("gatorsnake")
    inst.AnimState:SetBuild("gatorsnake")
    ...
    inst:SetStateGraph("SGgatorsnakehead")
    inst:SetBrain(brain)
...
return Prefab("gatorsnake", fnhead, assets, prefabs)--,
--Prefab("gatorsnakemid", fn, assets, prefabs),
--Prefab("gatorsnaketail", fn, assets, prefabs),--,
