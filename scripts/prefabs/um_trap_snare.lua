...
local function MakeTeethTrapNormal()
    local inst = common_fn("um_trap_snare", "trap_teeth", true)
...
return Prefab("um_trap_snare", MakeTeethTrapNormal, assets),
    MakePlacer("um_trap_snare_placer", "trap_teeth", "trap_teeth", "idle")--,
