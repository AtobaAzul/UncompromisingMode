...
local function MakeStrcuture(name, anim, add_decor)
	...
	return Prefab("hf_rubble_"..name, fn, assets, {"quagmire_old_rubble"})
end

return Prefab("hf_old_rubble", decorfn, assets),
		MakeStrcuture("carriage", "carriage"),
		MakeStrcuture("empty", nil, false),
		MakeStrcuture("clock", "grandfather_clock", false),
		MakeStrcuture("cathedral", "cathedral", false),
		MakeStrcuture("pubdoor", "pub_door", false),
		--MakeStrcuture("door", "door", false),
		MakeStrcuture("roof", "roof", false),
		MakeStrcuture("clocktower", "clocktower", false),
		MakeStrcuture("house", "house", false),
		MakeStrcuture("chimney", "chimney", false),
		MakeStrcuture("chimney2", "chimney2", false),
