...
local function DoAttack(inst)
    ...
    for i, v in ipairs(TheSim:FindEntities(x, y, z, ATTACK_RADIUS + 3, { "_combat" }, { "flying", "shadow", "ghost", "FX", "NOCLICK", "DECOR", "INLIMBO", "playerghost", "spider", "spiderden" })) do
...
return Prefab("minimoonspider_spike", fn, assets, prefabs)
