...
local function create_trapdoor()
    ...
    inst.components.combat:SetRange(1.05*TUNING.SPIDER_WARRIOR_ATTACK_RANGE, 1.05*TUNING.SPIDER_WARRIOR_HIT_RANGE)
...
return Prefab("nightcrawler", create_trapdoor, trapdoor_assets)
