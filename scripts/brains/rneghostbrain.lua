...
local RNEGhostBrain = Class(Brain, function(self, inst)
...
local function GetFollowTarget(ghost)
    ...
    if ghost.brain.followtarget == nil then
        ...
        local potential_followtargets = TheSim:FindEntities(gx, gy, gz, 100, {"lighttarget"}, { "INLIMBO", "noauradamage" })
...
function RNEGhostBrain:OnStart()
