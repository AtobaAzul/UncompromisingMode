...
local Night_Terror_ChargerBrain = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
    self.mytarget = nil
end)

function Night_Terror_ChargerBrain:SetTarget(target)
    if target ~= nil then
...
function Night_Terror_ChargerBrain:OnStop()
    self:SetTarget(nil)
end
...
function Night_Terror_ChargerBrain:OnStart()
...
return Night_Terror_ChargerBrain
