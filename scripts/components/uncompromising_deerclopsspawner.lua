...
return Class(function(self, inst)
    ...
    function self:DoWarningSound(_targetplayer)
        ...
        SpawnPrefab("deerclopswarning_lvl" ..
            (
            ((timetoattack == nil or timetoattack < 30) and "4") or (timetoattack < 60 and "3") or
                (timetoattack < 90 and "2") or "1")
    ...
    function self:GetDebugString()
        ...
        elseif timetoattack > 0 then
            s = s ..
                string.format("%s Deerclops is coming for %s in %2.2f", _warning and "WARNING" or "WAITING",
                    tostring(_targetplayer) or "<nil>", timetoattack)
        else
