...
local TransparentOnSanity_Dreadeye = Class(function(self, inst)
	self.inst = inst
...
function TransparentOnSanity_Dreadeye:OnUpdate(dt)
	self:DoUpdate(dt, false)
end

function TransparentOnSanity_Dreadeye:ForceUpdate()
	self:DoUpdate(0, true)
end

function TransparentOnSanity_Dreadeye:CalcaulteTargetAlpha()
...
function TransparentOnSanity_Dreadeye:DoUpdate(dt, force)
...
function TransparentOnSanity_Dreadeye:GetDebugString()
	return "alpha = "..self.alpha
end

return TransparentOnSanity_Dreadeye
