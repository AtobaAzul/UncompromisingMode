...
--]]
    if self.inst:HasTag("has_gasmask") or self.inst:HasTag("has_hayfeverhat") or self.inst:HasTag("minifansuppressor") or self.inst:HasTag("wereplayer") or TheWorld:HasTag("queenbeekilled") then -- or suppressorNearby
        can = false
    end
