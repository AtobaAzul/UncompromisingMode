...
GLOBAL.GetDescription = function(inst, item, ...)
	...
	if not inst:HasTag("playerghost") then
		...
		if prefab and item and item:HasTag("heatrock") and character ~= nil and character ~= "WES" and
			TUNING.DSTU.INSUL_THERMALSTONE then
		...
		if prefab and item and item:HasTag("vetsitem") and not inst:HasTag("vetcurse") and character ~= nil and
			character ~= "WES" then
