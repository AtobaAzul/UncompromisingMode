...
function setup_custom_loading_tips()
	...
	AddLoadingTip(GLOBAL.STRINGS.UI.LOADING_SCREEN_OTHER_TIPS, "TIP_UM_RATS_FOODSCORE", "\"Our rations appears to be attracting unwanted attention. I should get rid of our stale food...\" - W")
