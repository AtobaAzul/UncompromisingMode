...
STRINGS.CCTRINKET_NAMES = "Needed Nametag"
...
STRINGS.WINONA_SPOTLIGHT_ITEM_UM = "Packed " .. STRINGS.WINONA_SPOTLIGHT
STRINGS.WINONA_BATTERY_LOW_ITEM_UM = "Dissasembled " .. STRINGS.WINONA_BATTERY_LOW
STRINGS.WINONA_BATTERY_HIGH_ITEM_UM = STRINGS.WINONA_BATTERY_HIGH .. " Parts"
