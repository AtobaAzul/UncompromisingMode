...
local component_post = {
    "groundpounder", "propagator", "moisture", "weapon", --	"hunter",
    "kramped", "explosiveresist", "crop", "wildfires", --	"beargerspawner",
    "workable", "sleepingbaguser", "hounded", "sleeper", "fueled", "perishable",
    --	"carnivalevent",
    "lootdropper", "ambientsound", "foodaffinity", "eater", "edible",
    "inventory", -- This is an attempt at manually fixing an issue when people are checked for insulation. -scrimbles
    "weighable", "messagebottlemanager", "fishingnet", "boatleak", -- for custom boat patches.
    "wisecracker", "boatphysics", "map", "playerspawner", --	"drownable",
    "combat", "combat_replica", "hullhealth", "health", --	"spellbook"
    "finiteuses", "piratespawner", "repairable", "sewing", "container"
}

local prefab_post = {
    "wardrobe", "shieldofcthulu", "clockworks", "flingobalance", --	"chester",
    "mushlight", --	"toadstool_cap", Moved to init_uncompromising_mod.lua
    "amulet", "cave_entrance_open", "catcoon", "icehound", "firehound",
    "fishmeats", -- fish meat now dries into fish jerky
    "forest", "cave", "world", "antlion", "minifan", "spider", "hound", "ash",
    "bunnyman", "walls", "infestables", "foodbuffs", "mutatedhound", "skeleton",
    --	"shadowcreature",
    "berrybush", --	"papyrus",
    "sporecloud", "featherhat", --	"malbatross",
    "mushrooms", "rock_ice", "toadstool", "oasislake", --	"shadowcreature",
    "lureplant", "spiderden", "stafflights", "armor_ruins", "sweatervest",
    "fans", "skeletonhat", --	"rock_avocado_fruit_sprout_sapling",
    "icepack", "heatrock", "dragonfly_spawner", "rneghostfire", "monkey",
    "batcave", "rain", "molehat", "klaus", "mosquito", "armor_bramble",
    --	"woby",
    "cave_network", "glasscutter", "critterlab", "wobster", "trinkets", -- This is for the grave mound cc trinkets
    "trap", -- prevents traps and rabbits from 'sleeping' off screen
    "moonbase", "koalas", "pumpkin_lantern", "piggyback", "nightlight",
    "armor_sanity", "tophat", "tophatreduction", "ruinsstatues", "moondial",
    --	"deciduoustrees",
    "pktrades", "pigking", "marblebean", "reviver", "krampus_sack",
    --	"bundle",
    "eyebrella", "birds", "tonichandlers", "houndwarning", --	"carnival_host",
    "spider_whistle", "spider_healer", "siestahut", "bees", "farmplants",
    "rainhat", "darts", "terrarium", "bandage", "grassgekko", "minotaur_drops",
    "frog", "waterplant", --	"grassgator",
    "alterguardian", "seasonal_shoals", "petals", "lantern", "minerhat",
    "shark",
    --	"shadowchesspieces", Only bring this back when we make the fight cool
    "fertilizer", "stinger", "boat_pirate", "trident", -- for giving the leak a cause.
    "boat_bumpers", "slurtle_shellpieces", "sludge_fueled", "nightsword",
    "bigshadowtentacle", "mast", "multitool_axe_pickaxe", "staffs", -- generic staffs.
    "stalker", "sacred_chest", "soil_amender", "vetcurse_drops", "charcoal",
    "mermhat", "wptags", "inventoryitem_classified", "cannonballs",
    -- "renameable_items",
    "archive_centipede"
...
local stategraph_post = {
    "wilson", "wilson_client", "spider", "frog", --	"wobysmall",
    --	"shadowcreature",
    "stalker_minion", --	"merm",
    "carnival_host", "catcoon"
}
...
local class_post = {
    ...
    "widgets/moisturemeter", "widgets/controls", "widgets/craftslot",
    "widgets/bloodover"
}

local brain_post = {
    --	"hound",
    "frog", "nofirepanic", "chester", "mossling", "perd", "catcoon", "deer",
    "shadowwaxwell"
}
...
if GetModConfigData("wixie_walter") then
    local wixie_prefabs = {
        ...
        "wobysmall", "wobybig", "wormhole", -- wixie loses more sanity from wormholes
    ...
    RemapSoundEvent("dontstarve/characters/wixie/death_voice",
                    "wixie/characters/wixie/death_voice")
    RemapSoundEvent("dontstarve/characters/wixie/hurt",
                    "wixie/characters/wixie/hurt")
    RemapSoundEvent("dontstarve/characters/wixie/talk_LP",
                    "wixie/characters/wixie/talk_LP")
    RemapSoundEvent("dontstarve/characters/wixie/ghost_LP",
                    "wixie/characters/wixie/ghost_LP")
    RemapSoundEvent("dontstarve/characters/wixie/nightmare_LP",
                    "wixie/characters/wixie/nightmare_LP")
    RemapSoundEvent("dontstarve/characters/wixie/yawn",
                    "wixie/characters/wixie/yawn")
    RemapSoundEvent("dontstarve/characters/wixie/emote",
                    "wixie/characters/wixie/emote")
    RemapSoundEvent("dontstarve/characters/wixie/pose",
                    "wixie/characters/wixie/pose")
    RemapSoundEvent("dontstarve/characters/wixie/yawn",
                    "wixie/characters/wixie/yawn")
    RemapSoundEvent("dontstarve/characters/wixie/eye_rub_vo",
                    "wixie/characters/wixie/eye_rub_vo")
    RemapSoundEvent("dontstarve/characters/wixie/carol",
                    "wixie/characters/wixie/carol")
    RemapSoundEvent("dontstarve/characters/wixie/sinking",
                    "wixie/characters/wixie/sinking")
end
...
if GetModConfigData("harder_lavae") then table.insert(prefab_post, "lavae") end

if GetModConfigData("pinelings") then
    table.insert(prefab_post, "evergreen_stump")
end

if GetModConfigData("canedurability") then table.insert(prefab_post, "cane") end
...
if GetModConfigData("angry_werepigs") then table.insert(brain_post, "werepig") end
...
if GetModConfigData("amalgams") then table.insert(prefab_post, "chessjunk") end
--[[
...
if GetModConfigData("beefalo_nerf") then table.insert(component_post, "rider") end
...
if GetModConfigData("hambatnerf") then table.insert(prefab_post, "hambat") end

if GetModConfigData("townportal_rework") then
    table.insert(prefab_post, "townportal")
end

if GetModConfigData("monstersmallmeat") then table.insert(prefab_post, "bat") end
...
for _, v in pairs(component_post) do modimport("postinit/components/" .. v) end

for _, v in pairs(prefab_post) do modimport("postinit/prefabs/" .. v) end

for _, v in pairs(stategraph_post) do modimport("postinit/stategraphs/SG" .. v) end

for _, v in pairs(brain_post) do modimport("postinit/brains/" .. v .. "brain") end
