...
CONSTRUCTION_PLANS["multiplayer_portal_moonrock_constr"] = { Ingredient("moonrocknugget", 20),
    Ingredient("purplemooneye", 1), Ingredient("moonglass", 5) }
...
AllRecipes["moonrockidol"].ingredients = {
    Ingredient("moonrocknugget", GLOBAL.TUNING.DSTU.RECIPE_MOONROCK_IDOL_MOONSTONE_COST), Ingredient("purplegem", 1) }
...
if GetModConfigData("telestaff_rework") then
    ...
    AllRecipes["telestaff"].ingredients = { Ingredient("nightmarefuel", 2), Ingredient("spear", 1),
        Ingredient("purplegem", 1) }
    AllRecipes["purpleamulet"].ingredients = { Ingredient("goldnugget", 3), Ingredient("nightmarefuel", 2),
        Ingredient("purplegem", 1) }
end

AddRecipe2("ghostlyelixir_fastregen",
    { Ingredient(GLOBAL.CHARACTER_INGREDIENT.HEALTH, 50), Ingredient("ghostflower", 4) },
    TECH.MAGIC_TWO, { builder_tag = "elixirbrewer" }, { "CHARACTER" })
...
AllRecipes["mast_malbatross_item"].ingredients = { Ingredient("driftwood_log", 3), Ingredient("rope", 2),
    Ingredient("malbatross_feathered_weave", 3) }
AllRecipes["mast_malbatross"].ingredients = { Ingredient("driftwood_log", 3), Ingredient("rope", 2),
    Ingredient("malbatross_feathered_weave", 3) }

-- new recipes
if GetModConfigData("snowstorms") then
    AddRecipe2("snowgoggles", { Ingredient("catcoonhat", 1), Ingredient("goggleshat", 1), Ingredient("beefalowool", 2) },
        TECH.SCIENCE_TWO, nil, { "WINTER", "CLOTHING" })
...
if GetModConfigData("rat_raids") then
    AddRecipe2("ratpoisonbottle", { Ingredient("red_cap", 2), Ingredient("jammypreserves", 1), Ingredient("rocks", 1) },
        TECH.SCIENCE_ONE, nil, { "TOOLS" })
    ChangeSortKey("ratpoisonbottle", "trap", "TOOLS", true)
end

AddRecipe2("diseasecurebomb",
    { Ingredient("cactus_flower", 2), Ingredient("moonrocknugget", 2), Ingredient("spidergland", 3) }, TECH.SCIENCE_TWO,
    nil, { "GARDENING", "TOOLS", "RESTORATION" })
...
AddRecipe2("gasmask", { Ingredient("goose_feather", 10), Ingredient("red_cap", 2), Ingredient("pigskin", 2) },
    TECH.SCIENCE_TWO, nil, { "CLOTHING", "RAIN" })
ChangeSortKey("gasmask", "beehat", "CLOTHING", true)
ChangeSortKey("gasmask", "beehat", "RAIN", true)

AddRecipe2("plaguemask", { Ingredient("gasmask", 1), Ingredient("red_cap", 2), Ingredient("rat_tail", 4) },
    TECH.SCIENCE_TWO, nil, { "CLOTHING", "RAIN" })
...
if GetModConfigData("sporehounds") then
    AddRecipe2("shroom_skin", { Ingredient("shroom_skin_fragment", 4), Ingredient("froglegs", 2) }, TECH.SCIENCE_TWO, nil,
        { "REFINE" })
    ChangeSortKey("shroom_skin", "bearger_fur", "REFINE", true)
end

AddRecipe2("sporepack", { Ingredient("shroom_skin", 1), Ingredient("rope", 2), Ingredient("spoiled_food", 2) },
    TECH.SCIENCE_TWO, nil, { "CLOTHING", "CONTAINERS" })
...
if GetModConfigData("snowstorms") then
    AddRecipe2("saltpack", { Ingredient("gears", 1), Ingredient("boards", 2), Ingredient("saltrock", 8) },
        TECH.SCIENCE_TWO, nil, { "TOOLS", "WINTER" })
    ChangeSortKey("saltpack", "brush", "TOOLS", true)
    ChangeSortKey("saltpack", "beargervest", "WINTER", true)
end

AddRecipe2("air_conditioner", { Ingredient("shroom_skin", 2), Ingredient("gears", 1), Ingredient("cutstone", 2) },
    TECH.SCIENCE_TWO, { placer = "air_conditioner_placer" }, { "STRUCTURES" })
ChangeSortKey("air_conditioner", "firesuppressor", "STRUCTURES", true)

AddRecipe2("skullchest_child", { Ingredient("fossil_piece", 2), Ingredient("nightmarefuel", 4), Ingredient("boards", 3) },
    TECH.LOST, { placer = "skullchest_child_placer" }, { "STRUCTURES", "CONTAINERS", "MAGIC" })
...
if GetModConfigData("hayfever_disable") then -- not in dev build since the config is commented off, but live does have it.
    AddRecipe2("honey_log", { Ingredient("livinglog", 1), Ingredient("honey", 2) }, TECH.NONE,
        { builder_tag = "plantkin" },
        { "CHARACTER" })
    ChangeSortKey("honey_log", "livinglog", "CHARACTER", true)
end

AddRecipe2("bugzapper", { Ingredient("spear", 1), Ingredient("transistor", 2), Ingredient("feather_canary", 2) },
    TECH.SCIENCE_TWO, nil, { "WEAPONS" })
ChangeSortKey("bugzapper", "nightstick", "WEAPONS", true)

AddRecipe2("watermelon_lantern", { Ingredient("watermelon", 1), Ingredient("fireflies", 1) }, TECH.SCIENCE_TWO, nil,
    { "LIGHT" })
...
if GetModConfigData("rat_raids") or GetModConfigData("funny rat") then
    AddRecipe2("rat_whip", { Ingredient("twigs", 3), Ingredient("rope", 1), Ingredient("rat_tail", 3) }, TECH
        .SCIENCE_TWO, nil, { "WEAPONS" })
    ChangeSortKey("rat_whip", "whip", "WEAPONS", true)
end

AddRecipe2("ancient_amulet_red", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 3), Ingredient("redgem", 2) },
    TECH.ANCIENT_FOUR, { nounlock = true }, { "CRAFTING_STATION" })
ChangeSortKey("ancient_amulet_red", "orangeamulet", "CRAFTING_STATION", true)

if GetModConfigData("hoodedforest") then
    AddRecipe2("turf_hoodedmoss", { Ingredient("twigs", 1), Ingredient("greenfoliage", 4) }, TECH.TURFCRAFTING_TWO,
        { numtogive = 4 }, { "DECOR" })
    ChangeSortKey("turf_hoodedmoss", "turf_deciduous", "DECOR", true)

    AddRecipe2("turf_ancienthoodedturf", { Ingredient("turf_hoodedmoss", 2), Ingredient("moonrocknugget", 1) },
        TECH.TURFCRAFTING_TWO, { numtogive = 4 }, { "DECOR" })
    ChangeSortKey("turf_ancienthoodedturf", "turf_hoodedmoss", "DECOR", true)
end

AddRecipe2("um_bear_trap_equippable_tooth",
    { Ingredient("cutstone", 2), Ingredient("houndstooth", 3), Ingredient("rope", 1) }, TECH.SCIENCE_TWO, { nil },
    { "WEAPONS" })
ChangeSortKey("um_bear_trap_equippable_tooth", "trap_teeth", "WEAPONS", true)

AddRecipe2("um_bear_trap_equippable_gold",
    { Ingredient("goldnugget", 4), Ingredient("houndstooth", 3), Ingredient("rope", 1) }, TECH.SCIENCE_TWO, { nil },
    { "WEAPONS" })
ChangeSortKey("um_bear_trap_equippable_gold", "um_bear_trap_equippable_tooth", "WEAPONS", true)

if GetModConfigData("wiltfly") then
    AddRecipe2("armor_glassmail", { Ingredient("glass_scales", 1), Ingredient("moonglass_charged", 10) },
        TECH.CELESTIAL_THREE, { nounlock = true }, { "CRAFTING_STATION" })
    ChangeSortKey("armor_glassmail", "glasscutter", "CRAFTING_STATION", true)
end

if GetModConfigData("trapdoorspiders") then
    AddRecipe2("mutator_trapdoor",
        { Ingredient("monstermeat", 2), Ingredient("spidergland", 3), Ingredient("cutgrass", 5) }, TECH.SPIDERCRAFT_ONE,
        { builder_tag = "spiderwhisperer" }, { "CHARACTER" })
    ChangeSortKey("mutator_trapdoor", "mutator_warrior", "CHARACTER", true)
end

AddRecipe2("driftwoodfishingrod", { Ingredient("driftwood_log", 3), Ingredient("silk", 3), Ingredient("rope", 2) },
    TECH.SCIENCE_TWO, nil, { "TOOLS", "FISHING" })
ChangeSortKey("driftwoodfishingrod", "fishingrod", "TOOLS", true)
ChangeSortKey("driftwoodfishingrod", "fishingrod", "FISHING", true)

AddRecipe2("uncompromising_fishingnet", { Ingredient("rope", 1), Ingredient("rocks", 2), Ingredient("silk", 3) },
    TECH.SCIENCE_ONE, nil, { "TOOLS", "FISHING" })
...
AddRecipe2("um_magnerang", { Ingredient("boomerang", 1), Ingredient("transistor", 2), Ingredient("steelwool", 3) },
    TECH.SCIENCE_TWO, nil, { "WEAPONS" })
ChangeSortKey("um_magnerang", "boomerang", "WEAPONS", true)

AddRecipe2("hermitshop_rain_horn",
    { Ingredient("dormant_rain_horn", 1), Ingredient("oceanfish_small_9_inv", 3), Ingredient("messagebottleempty", 2) },
    TECH.HERMITCRABSHOP_SEVEN, { nounlock = true, product = "rain_horn" }, { "CRAFTING_STATION" })
ChangeSortKey("hermitshop_rain_horn", "hermitshop_oceanfishingbobber_malbatross", "CRAFTING_STATION", true)

if GetModConfigData("rat_raids") then
    AddRecipe2("hat_ratmask", { Ingredient("rope", 2), Ingredient("beardhair", 3), Ingredient("sewing_kit", 1) },
        TECH.SCIENCE_TWO, nil, { "CLOTHING" })
    ChangeSortKey("hat_ratmask", "plaguemask", "CLOTHING", true)
end

AddRecipe2("floral_bandage", { Ingredient("bandage", 1), Ingredient("cactus_flower", 2) }, TECH.SCIENCE_TWO, nil,
    { "RESTORATION" })
ChangeSortKey("floral_bandage", "bandage", "RESTORATION", true)

AddRecipe2("winona_toolbox", { Ingredient("boards", 2), Ingredient("goldnugget", 4), Ingredient("sewing_tape", 2) },
    TECH.NONE, { builder_tag = "handyperson" }, { "CONTAINERS", "CHARACTER" })
ChangeSortKey("winona_toolbox", "treasurechest", "CONTAINERS", true)
ChangeSortKey("winona_toolbox", "sewing_tape", "CHARACTER", true)

AddRecipe2("powercell", { Ingredient("sewing_tape", 1), Ingredient("goldnugget", 1), Ingredient("nitre", 2) }, TECH.NONE,
    { builder_tag = "handyperson", numtogive = 3 }, { "CHARACTER" })
ChangeSortKey("powercell", "winona_battery_high", "CHARACTER", true)

AddRecipe2("winona_upgradekit_electrical",
    { Ingredient("goldnugget", 6), Ingredient("sewing_tape", 2), Ingredient("trinket_6", 2) }, TECH.SCIENCE_TWO,
    { builder_tag = "handyperson" }, { "CHARACTER", "LIGHT" })
...
AddRecipe2("sludge_sack", { Ingredient("sludge", 6), Ingredient("rockjawleather", 2), Ingredient("rope", 3) },
    TECH.SCIENCE_TWO, nil, { "CONTAINERS", "CLOTHING" })
ChangeSortKey("sludge_sack", "piggyback", "CONTAINERS", true)
ChangeSortKey("sludge_sack", "piggyback", "CLOTHING", true)

AddRecipe2("boat_bumper_sludge_kit", { Ingredient("sludge", 4), Ingredient("driftwood_log", 2) }, TECH.SEAFARING_ONE,
    { numtogive = 2 }, { "SEAFARING" })
ChangeSortKey("boat_bumper_sludge_kit", "boat_bumper_shell_kit", "SEAFARING", true)

AddRecipe2("cannonball_sludge_item", { Ingredient("sludge", 2), Ingredient("nitre", 1), Ingredient("charcoal", 1) },
    TECH.SEAFARING_ONE, { numtogive = 4 }, { "WEAPONS", "SEAFARING" })
...
AddRecipe2("sludge_oil", { Ingredient("sludge", 3), Ingredient("messagebottleempty", 1) }, TECH.SCIENCE_TWO, nil,
    { "TOOLS", "LIGHT" })
...
AddRecipe2("armor_sharksuit_um", { Ingredient("armorwood", 1), Ingredient("rockjawleather", 1), Ingredient("sludge", 4) },
    TECH.SCIENCE_TWO, nil, { "SEAFARING", "ARMOUR", "RAIN" })
...
AddRecipe2("brine_balm", { Ingredient("saltrock", 2), Ingredient("kelp", 1) }, -- , Ingredient("driftwood_log", 1)
    TECH.SCIENCE_ONE, nil,                                                     -- {numtogive = 2},
    { "RESTORATION" })
ChangeSortKey("brine_balm", "floral_bandage", "RESTORATION", true)

AddRecipe2("sludge_cork", { Ingredient("driftwood_log", 2), Ingredient("rope", 2) }, TECH.SCIENCE_ONE, nil,
    { "TOOLS", "SEAFARING" })
...
if GetModConfigData("monstersmallmeat") then
    AddRecipe2("transmute_monstermeat", { Ingredient("monstersmallmeat", 3) }, TECH.NONE,
        { product = "monstermeat", builder_tag = "ick_alchemistI", description = "transmute_monstermeat" },
        { "CHARACTER" })

    AddRecipe2("transmute_monstersmallmeat", { Ingredient("monstermeat", 1) }, TECH.NONE,
        {
...
AddRecipe2("hermitshop_hermit_bundle_lures", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_ONE,
...
AddRecipe2("hermitshop_boat", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_ONE,
...
AddRecipe2("hermitshop_mast", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_ONE,
    { nounlock = true, product = "mast_item", sg_state = "give" })
ChangeSortKey("hermitshop_mast", "hermitshop_boat", "CRAFTING_STATION", true)

AddRecipe2("hermitshop_anchor", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_ONE,
    { nounlock = true, product = "anchor_item", sg_state = "give" })
ChangeSortKey("hermitshop_anchor", "hermitshop_mast", "CRAFTING_STATION", true)

AddRecipe2("hermitshop_steeringwheel", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_ONE,
...
AddRecipe2("hermitshop_patch", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_ONE,
...
AddRecipe2("hermitshop_blueprint", { Ingredient("messagebottleempty", 1) }, GLOBAL.TECH.HERMITCRABSHOP_THREE,
...
AddRecipe2("hermitshop_waterplant", { Ingredient("messagebottleempty", 3) }, TECH.HERMITCRABSHOP_FIVE,
...
AddRecipe2("hermitshop_cookies", { Ingredient("messagebottleempty", 1) }, TECH.HERMITCRABSHOP_SEVEN,
...
AddRecipe2("normal_chum", { Ingredient("spoiled_food", 2), Ingredient("rope", 1), Ingredient("waterplant_bomb", 1) },
    TECH.FISHING_ONE, { product = "chum", nounlock = false, numtogive = 2 }, { "FISHING" })
...
-- better moonstorm
AddRecipe2("moonstorm_static_item",
    { Ingredient("transistor", 1), Ingredient("moonstorm_spark", 2), Ingredient("goldnugget", 3) }, TECH.LOST, nil,
    { "REFINE" })
AddRecipe2("alterguardianhatshard",
    { Ingredient("moonglass_charged", 1), Ingredient("moonstorm_spark", 2), Ingredient("lightbulb", 1) }, TECH.LOST, nil,
    { "LIGHT", "REFINE" })

AddDeconstructRecipe("alterguardianhat",
    { Ingredient("alterguardianhatshard", 5), Ingredient("alterguardianhatshard_blueprint", 1) })

AddRecipe2("critter_figgy_builder", { Ingredient("steelwool", 1), Ingredient("blueberrypancakes", 1) },
    TECH.ORPHANAGE_ONE, { nounlock = true, actionstr = "ORPHANAGE" })
...
AddRecipe2("mastupgrade_windturbine_item", { Ingredient("cutstone", 2), Ingredient("transistor", 2) }, TECH
    .SEAFARING_ONE, nil, { "SEAFARING" })
...
if GetModConfigData("ck_loot") then
    ...
    AddRecipe2("armor_crab_maxhp",
        { Ingredient("cutstone", 1), Ingredient("redgem", 3), Ingredient("slurtle_shellpieces", 3) }, TECH.LOST, nil,
        { "ARMOUR" })

    AddRecipe2("armor_crab_regen",
        { Ingredient("cutstone", 1), Ingredient("greengem", 3), Ingredient("slurtle_shellpieces", 3) }, TECH.LOST, nil,
        { "ARMOUR" })

    AddRecipe2("staff_starfall",
        { Ingredient("yellowgem", 3), Ingredient("slurtle_shellpieces", 5), Ingredient("livinglog", 3) }, TECH.LOST, nil,
        { "WEAPONS", "SHADOWMAGIC" })
...
if GetModConfigData("wixie_walter") then
    AddRecipe2("the_real_charles_t_horse",
        { Ingredient("nightmarefuel", 2), Ingredient("cane", 1), Ingredient("gears", 1) }, GLOBAL.TECH.LOST, nil,
        { "TOOLS", "CLOTHING" })
    ...
    AddRecipe2("slingshot_matilda",
        { Ingredient("driftwood_log", 1), Ingredient("coontail", 1), Ingredient("mosquitosack", 3) },
        GLOBAL.TECH.SCIENCE_TWO, { builder_tag = "pebblemaker" }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_shadow", { Ingredient("nightmarefuel", 1) }, GLOBAL.TECH.LOST,
        { builder_tag = "pebblemaker", numtogive = 10, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_firecrackers", { Ingredient("nitre", 1) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 15, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_honey", { Ingredient("honey", 3) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 10, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_rubber", { Ingredient("mosquitosack", 1) }, GLOBAL.TECH.SCIENCE_ONE,
        { builder_tag = "pebblemaker", numtogive = 15, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_tremor", { Ingredient("townportaltalisman", 1) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 10, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_moonrock", { Ingredient("moonrocknugget", 1) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 15, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_moonglass", { Ingredient("moonglass", 1) }, GLOBAL.TECH.CELESTIAL_THREE,
    ...
    AddRecipe2("slingshotammo_salt", { Ingredient("saltrock", 1) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 15, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_slime", { Ingredient("slurtleslime", 1), Ingredient("rocks", 1) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 10, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_goop", { Ingredient("glommerfuel", 1) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 5, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_tar", { Ingredient("placeholder_ingredient_ia_um", 0) }, GLOBAL.TECH.SCIENCE_TWO,
        { builder_tag = "pebblemaker", numtogive = 10, no_deconstruction = true }, { "CHARACTER", "WEAPONS" })
    ...
    AddRecipe2("slingshotammo_obsidian", { Ingredient("placeholder_ingredient_ia", 0) }, GLOBAL.TECH.OBSIDIAN_TWO,
        { builder_tag = "pebblemaker", numtogive = 10, no_deconstruction = true, nounlock = true },
    ...
    AddRecipe2("meatrack_hat", { Ingredient("twigs", 2), Ingredient("rope", 1), Ingredient("charcoal", 1) },
        GLOBAL.TECH.NONE, { builder_tag = "pinetreepioneer" }, { "CHARACTER", "COOKING", "CLOTHING" })
