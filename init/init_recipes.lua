...
CONSTRUCTION_PLANS["multiplayer_portal_moonrock_constr"] = {Ingredient("moonrocknugget", 20), Ingredient("purplemooneye", 1), Ingredient("moonglass", 5)}
...
if GetModConfigData("wanda_nerf") then
    AllRecipes["pocketwatch_revive"].ingredients = {Ingredient("pocketwatch_parts", 3), Ingredient("livinglog", 2), Ingredient("boneshard", 4)}
end
...
if GetModConfigData("book_recipes") then
    ...
    AllRecipes["book_bees"].ingredients = {Ingredient("papyrus", 2), Ingredient("honeycomb", 1), Ingredient("stinger", 8)}
...
if GetModConfigData("no4crafts") then -- :desolate:
    AllRecipes["dock_kit"].ingredients = {Ingredient("boards", 4), Ingredient("stinger", 2), Ingredient("palmconetree_scale", 4)}
...
if GetModConfigData("telestaff_rework") then
    ...
    AllRecipes["telestaff"].ingredients = {Ingredient("nightmarefuel", 2), Ingredient("spear", 1), Ingredient("purplegem", 1)}
    AllRecipes["purpleamulet"].ingredients = {Ingredient("goldnugget", 3), Ingredient("nightmarefuel", 2), Ingredient("purplegem", 1)}
end
...
if GetModConfigData("rat_raids") then
    AddRecipe2("ratpoisonbottle", {Ingredient("red_cap", 2), Ingredient("jammypreserves", 1), Ingredient("rocks", 1)}, TECH.SCIENCE_ONE, nil, {"TOOLS"})
...
AddRecipe2("um_magnerang", {Ingredient("boomerang", 1), Ingredient("transistor", 2), Ingredient("steelwool", 3)}, TECH.SCIENCE_TWO, nil, {"WEAPONS"})
...
AddRecipe2("winona_upgradekit_electrical", {Ingredient("goldnugget", 6), Ingredient("sewing_tape", 2), Ingredient("trinket_6", 2)}, TECH.SCIENCE_TWO, {builder_tag = "handyperson"}, {"CHARACTER", "LIGHT"})
...
AddRecipe2("cannonball_sludge_item", {Ingredient("sludge", 2), Ingredient("nitre", 1), Ingredient("charcoal", 1)}, TECH.SEAFARING_ONE, {numtogive = 4}, {"WEAPONS", "SEAFARING"})
...
if GetModConfigData("monstersmallmeat") then
    AddRecipe2("transmute_monstermeat", {Ingredient("monstersmallmeat", 3)}, TECH.NONE, {product = "monstermeat", builder_tag = "ick_alchemistI", description = "transmute_monstermeat"}, {"CHARACTER"})

    AddRecipe2("transmute_monstersmallmeat", {Ingredient("monstermeat", 1)}, TECH.NONE, {product = "monstersmallmeat", builder_tag = "ick_alchemistI", description = "transmute_monstersmallmeat", numtogive = 2}, {"CHARACTER"})
...
AddRecipe2("hermitshop_waterplant", {Ingredient("messagebottleempty", 3)}, TECH.HERMITCRABSHOP_FIVE, {nounlock = true, product = "waterplant_planter", sg_state = "give"})
...
AddRecipe2("normal_chum", {Ingredient("spoiled_food", 2), Ingredient("rope", 1), Ingredient("waterplant_bomb", 1)}, TECH.FISHING_ONE, {product = "chum", nounlock = false, numtogive = 2}, {"FISHING"})
...
if GetModConfigData("ck_loot") then
    AddRecipe2("crab_hat", {Ingredient("cutstone", 2), Ingredient("orangegem", 2), Ingredient("slurtle_shellpieces", 1)}, TECH.LOST, nil, {"CLOTHING"})

    AddRecipe2("crab_hat_ice", {Ingredient("cutstone", 2), Ingredient("bluegem", 2), Ingredient("slurtle_shellpieces", 1)}, TECH.LOST, nil, {"ARMOUR"})
...
if GetModConfigData("wixie_walter") then
    AddRecipe2("the_real_charles_t_horse", {Ingredient("nightmarefuel", 2), Ingredient("cane", 1), Ingredient("gears", 1)}, GLOBAL.TECH.LOST, nil, {"TOOLS", "CLOTHING"})
