...
-- CaliforniaKing
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_CALIFORNIAKING = "A warrior can!... can?"
...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    "Hel's fury is upon us!", "Ragnarok has come!", "The beast roars loud!"
}
...
ANNOUNCE.SHADOWTALKER = {
    "SHE IS NO MORE", "THIS IS WHERE I BELONG", "I DON'T WANT TO GO BACK"
}
...
DESCRIBE.PURPLESTEAMEDHAMS = "'Tis obviously grilled!"
DESCRIBE.GREENSTEAMEDHAMS = "'Tis obviously grilled!"
DESCRIBE.BLUEBERRYPANCAKES = "I will resist!"
DESCRIBE.DEVILSFRUITCAKE = "You cannot tempt me, Hel!"
...
DESCRIBE.UM_BEAR_TRAP_EQUIPPABLE_TOOTH = "A devious weapon!"
...
DESCRIBE.BOOK_RAIN_UM = "A tome to dampen the battleground."
...
DESCRIBE.WINONA_CATAPULT_ITEM_UM = "An evil contraption!"
DESCRIBE.WINONA_SPOTLIGHT_ITEM_UM = "An evil contraption!"
DESCRIBE.WINONA_BATTERY_LOW_ITEM_UM = "An evil contraption!"
...
DESCRIBE.OCUPUS_BEAK = "I'd prefer to eat it."
...
DESCRIBE.UM_OCUPUS_EYE = "A murky combatant awaits."
DESCRIBE.UM_OCUPUS_EYETACLE = "It's time to go for the eyes!"
DESCRIBE.UM_OCUPUS_TENTACLE = "The challenger from the depths responds!"
DESCRIBE.UM_OCUPUS_BEAK = "No fair! You're acting out of character."
DESCRIBE.BEAKBASHER = "A perfect warhammer forged from the briny abyss."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "It will notify me of challenger's arrival!"
...
DESCRIBE.EYEOFTERROR_MINI_ALLY = "You fight with the might of Odin's eye!"
