...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    "Ack! Owie!", "Rain, rain, go away!", "Ow! Our fur's getting singed!"
}
...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    ...
    "The ground is getting extra tingly!", "Watch out!"
}
...
DESCRIBE.VET_SKULL = "Oh no, someone lost their head!"
DESCRIBE.UM_BOSS_SOUL = "Someone lost their soul!"
DESCRIBE.UM_DARK_VESTIGES = "We don't like this..."
DESCRIBE.UM_VOXOLOPHONE = "We shouldn't talk to strangers..."

DESCRIBE.UM_EXHUMER = "Hello Mr. Bone Man!"
DESCRIBE.UM_WINGSUIT = "We are scared of heights..."
DESCRIBE.UM_MOONFLY_LANTERN = "We like the way you glow!"
...
DESCRIBE.PURPLESTEAMEDHAMS = "This is just a hamburger."
DESCRIBE.GREENSTEAMEDHAMS = "This is just a hamburger."
DESCRIBE.BLUEBERRYPANCAKES = "It's really sweet!"
DESCRIBE.DEVILSFRUITCAKE = "We hope we don't get a stomach ache..."
...
DESCRIBE.WINONA_CATAPULT_ITEM_UM = "I don't want to lose an arm!"
DESCRIBE.WINONA_SPOTLIGHT_ITEM_UM = "I don't want to lose an arm!"
DESCRIBE.WINONA_BATTERY_LOW_ITEM_UM = "I don't want to lose an arm!"
...
DESCRIBE.OCUPUS_BEAK = "We have this now, great."
...
DESCRIBE.UM_OCUPUS_EYE = "We're used to many eyes, these are a bit too far apart."
DESCRIBE.UM_OCUPUS_EYETACLE = "The big guy may let us go if we blind them."
DESCRIBE.UM_OCUPUS_TENTACLE = "It's big, mad, and sucky."
DESCRIBE.UM_OCUPUS_BEAK = "Yep, it's wanting to eat us."
DESCRIBE.BEAKBASHER = "Even the most mundane things can be put to use."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "We tried to make the tree look like a big spider. I don't think it worked."
