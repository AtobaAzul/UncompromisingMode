...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    ...
    "L-Lucy?! You got a drop on you!", "Don't worry Luce', I got you."
}
...
-- CaliforniaKing
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_CALIFORNIAKING = "Here we go again..."
ANNOUNCE.ANNOUNCE_DETACH_BUFF_CALIFORNIAKING = "Lu- Lucy is that you?"
...
DESCRIBE.RICE = "I would prefer it not so tough."
DESCRIBE.RICE_COOKED = "It's nice, but it could have been done better."
DESCRIBE.SEAFOODPAELLA = "Time to eat up!"
DESCRIBE.LICELOAF = "Well, this was the best I could do."
DESCRIBE.SUNGLASSES = "What do you think Lucy? Do I look good in these?"
...
DESCRIBE.PURPLESTEAMEDHAMS = "Mouth watering hamburgers."
DESCRIBE.GREENSTEAMEDHAMS = "Mouth watering hamburgers."
DESCRIBE.BLUEBERRYPANCAKES = "It ain't maple syrup, but it'll do just nicely."
DESCRIBE.DEVILSFRUITCAKE = "Looks like an instant cavity, eh?"
...
DESCRIBE.BIGHT = "This metal ain't so dead, eh?"
...
DESCRIBE.WINONA_CATAPULT_ITEM_UM = "Is it broken?"
DESCRIBE.WINONA_SPOTLIGHT_ITEM_UM = "Is it broken?"
...
DESCRIBE.OCUPUS_BEAK = "Bird or not, still a hoser."
...
DESCRIBE.OCUPUS_TENTACLE_COOKED = "it's not that bad once ya peel back the skin."
DESCRIBE.UM_OCUPUS_EYE = "I really don't want to go over there."
DESCRIBE.UM_OCUPUS_EYETACLE = "I think we oughta take those out."
DESCRIBE.UM_OCUPUS_TENTACLE = "There's definately a squid down there."
DESCRIBE.UM_OCUPUS_BEAK = "That better not be a bird."
DESCRIBE.BEAKBASHER = "A beak on a stick. Great."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "I have no words."
...
DESCRIBE.TRINKET_WATHOM1 = "Well that's a right load'a malarky."
