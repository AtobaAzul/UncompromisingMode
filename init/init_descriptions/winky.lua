...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    "My fur is melting!", "Aaah the rain smells of burning!",
...
DESCRIBE.PURPLESTEAMEDHAMS = "These steamed hams are very similar to the ones they have at PorkShire."
DESCRIBE.GREENSTEAMEDHAMS = "These steamed hams are very similar to the ones they have at PorkShire."
DESCRIBE.BLUEBERRYPANCAKES = "This home-made blue slime is very satisfying."
DESCRIBE.DEVILSFRUITCAKE = "Evil cake for evil beings."
...
DESCRIBE.WINONA_CATAPULT_ITEM_UM = "Funny little machine!"
DESCRIBE.WINONA_SPOTLIGHT_ITEM_UM = "Funny little machine!"
DESCRIBE.WINONA_BATTERY_LOW_ITEM_UM = "Funny little machine!"
DESCRIBE.WINONA_BATTERY_HIGH_ITEM_UM = "Funny little machine!"
...
DESCRIBE.UM_OCUPUS_EYE = "Doesn't look like a welcome crew."
DESCRIBE.UM_OCUPUS_EYETACLE = "I'll eat your liver if you keep this up."
DESCRIBE.UM_OCUPUS_TENTACLE = "That floppy better stoppy."
DESCRIBE.UM_OCUPUS_BEAK = "Its screeching is driving me mad."
DESCRIBE.BEAKBASHER = "I put that thing to good use."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "It'll let me know when more victims arrive."
