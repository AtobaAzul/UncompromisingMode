...
"It's labeled \"Do not drink. That means you, Webber.\""
...
ANNOUNCE.SHADOWTALKER = {
    "THERES NO ESCAPE", "THEY ARE OUT THERE, WATCHING, ALWAYS",
    "IT'S ONLY A MATTER OF TIME", "WHAT YEAR IS IT OUT THERE?",
    "NOTHING BUT DARKNESS", "IT'S A NEVER ENDING CYCLE",
    "HOW MANY TIMES HAVE I DIED HERE?", "WHAT DID I DO TO DESERVE THIS?",
...
"Science says it would hurt if you ran into it. Probably."
...
DESCRIBE.MOON_TEAR =
"I think the moon is upset at it's missing piece. Let's keep this safe."
...
"My legs are getting flimsy again."
