...
--	[ 		Winona Descriptions		]	--
    ...
    ANNOUNCE.ANNOUNCE_TOADSTOOLED = "Something's building up down there!"

    DESCRIBE.RAT = "That's one part of home I was hoping NOT to see again."
    DESCRIBE.RAT_BURROW = "Seems you've been ratted out!"
    
    DESCRIBE.MONSTERSCRAP = "Not too sure why I wanted this..."
    DESCRIBE.COOKEDMONSTERSCRAP = "Does cooking something like this make it food?"
    DESCRIBE.MONSTERSCRAP_DRIED = "Old, sad anger meat."
