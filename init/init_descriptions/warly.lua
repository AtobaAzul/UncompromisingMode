...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    ...
    "Ow! What is with this rain?", "Ah! I'm being sautéed!"
}
...
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_VETCURSE = "I feel sick..."
...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    "What? More?!", "Careful not to get charbroiled!",
...
ANNOUNCE.SHADOWTALKER = {
    "SHE IS ALL ALONE", "SHE DOESN'T REMEMBER ME", "I'M NOT THERE FOR HER"
}
...
DESCRIBE.PURPLESTEAMEDHAMS = "Tastes like fast food."
DESCRIBE.GREENSTEAMEDHAMS = "Tastes like fast food."
DESCRIBE.BLUEBERRYPANCAKES = "Didn't even have to add any sugar to the berries."
DESCRIBE.DEVILSFRUITCAKE = "And I didn't even have to sell my soul!"
DESCRIBE.SIMPSALAD =
...
DESCRIBE.MOONGLASS_GEODE = "Not quite glass."
DESCRIBE.ARMOR_GLASSMAIL = "Merveilleux! I'm untouchable!"
DESCRIBE.ARMOR_GLASSMAIL_SHARDS = "Bad idea to cross me!"
...
DESCRIBE.WOODPECKER = "The wood might give it a smoky flavor."
DESCRIBE.SNOTROAST = "This has to be the worst dish I've created."
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_LARGEHUNGERSLOW = "I'll never eat again."
...
DESCRIBE.UM_OCUPUS_EYE = "I don't like whatever this is."
DESCRIBE.UM_OCUPUS_EYETACLE = "The beast will let us go if it can't see."
DESCRIBE.UM_OCUPUS_TENTACLE = "Definately calamari."
DESCRIBE.UM_OCUPUS_BEAK = "Is it you again!?"
DESCRIBE.BEAKBASHER = "A hammer? I was trying to make a kabob out of it."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "What a waste of a mandrake. Could have been a good soup."
