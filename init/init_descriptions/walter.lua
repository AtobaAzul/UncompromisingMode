...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    ...
    "The grounds getting hot!", "Just keep calm!"
}
...
ANNOUNCE.SHADOWTALKER = {
    "I MUST PROTECT HER", "I SHOULDN'T HAVE DONE IT", "I CAN'T GIVE UP",
    "I AM AFRAID"
}
...
DESCRIBE.UM_SCORPION =
    "Fun fact: You can suck the venom out of a bite wound! Not sure about scorpion stings though..."
DESCRIBE.SCORPIONCARAPACE = "Uhh, Woby, you can have this one."
DESCRIBE.SCORPIONCARAPACECOOKED =
    "It's slightly better, but I would rather Woby have it."
