...
--	[ 		Wathom Descriptions		]   --
    ...
    ANNOUNCE.ANNOUNCE_ACIDRAIN = {
        "Carapace, burning!!",
        "Weather, poisoned! Toad parasite, presumably.",
        "Rain, bad.",
    }
	...
	--CaliforniaKing
	ANNOUNCE.ANNOUNCE_ATTACH_BUFF_CALIFORNIAKING = "Yes, good drink, drinkgoodyes, drgrnn...rgg.."
	...
	ANNOUNCE.SHADOWTALKER = {
        "ABYSS, BECKONING.",
        "MAKER SCHEMES. EVERYONE SCHEMES.",
	...
	DESCRIBE.MINOTAUR_BOULDER_BIG = "Guardian, momentum uncontrollable. Strategy recognized!"
	...
	DESCRIBE.RAT_TAIL = "Only skin, bones. Quelled, ally concerns - disease unlikely."
	...
	DESCRIBE.BERNIE_BIG =
        {
            GENERIC = "Not me! Not me!",
            ASHLEY = "Not me! Not me!",
        }
	...
	ACTIONFAIL.GIVE = {NOTNIGHT = "Presense required, Alter's gaze."}
