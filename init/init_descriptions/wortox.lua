...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    "Aerial attack! I'm in need of a shack!", "A sour turn, the water burns!",
    "Ouch! Hyuyu!"
}
...
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_VETCURSE = "I have yet another curse?"
...
ANNOUNCE.SHADOWTALKER = {
    "I CAN CHANGE. I HAVE CHANGED.", "I STILL FEEL THE HUNGER",
    "JUST LAUGH IT OFF"
}
...
DESCRIBE.LUREPLAGUE_RAT = "Take the dead."
...
DESCRIBE.PURPLESTEAMEDHAMS = "This dish has got to be joking."
DESCRIBE.GREENSTEAMEDHAMS = "This dish has got to be joking."
...
DESCRIBE.OCUPUS_BEAK = "Got your nose."
...
DESCRIBE.OCUPUS_TENTACLE_COOKED = "Burnt sucker."
DESCRIBE.UM_OCUPUS_EYE = "Something is looking for a certain imp."
DESCRIBE.UM_OCUPUS_EYETACLE = "It'll leave us be if it cannot see!"
DESCRIBE.UM_OCUPUS_TENTACLE = "It's big and wet and trying to get me!"
DESCRIBE.UM_OCUPUS_BEAK = "It really wants me dead right now."
DESCRIBE.BEAKBASHER = "To establish the new pecking order."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "Wowee golly those eyes are like holly."
...
DESCRIBE.CANNONBALL_SLUDGE_ITEM = "It will leave foe alike in smithereens!"
