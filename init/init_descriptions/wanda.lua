...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    ...
    "Botheration, the rumbling is getting worse!", "Watch your step, everyone!"
}
ANNOUNCE.ANNOUNCE_ROOTING = "Rewind, rewind!!"
ANNOUNCE.ANNOUNCE_SNOWSTORM =
"Wind is picking up, I think it's time for a storm!"
ANNOUNCE.SHADOWTALKER = {
    "TICK, TOCK, TICK, TOCK", "TIME IS WASTING...", "I JUST NEEDED MORE TIME",
...
DESCRIBE.VET_SKULL = "The clock stopped long ago for this one."
DESCRIBE.UM_BOSS_SOUL = "Something lingers inside it."
DESCRIBE.UM_DARK_VESTIGES = "It's constantly moving..."
DESCRIBE.UM_VOXOLOPHONE = "I can't tell when this was made, and by whom..."

DESCRIBE.UM_EXHUMER = "I guess something *can* wind the clock back on death."
DESCRIBE.UM_WINGSUIT = "Early bird gets the worm, or so they say."
DESCRIBE.UM_MOONFLY_LANTERN = "Very convenient."
...
"Why would I ever want to spray mushrooms into the air?"
...
"Clearly the constructor didn't have the time to make it safe!"
ANNOUNCE.ANNOUNCE_CHARGE_SUCCESS_ELECTROCUTED =
"It's not even insulated properly!"

----UNDER THE WEATHER----

DESCRIBE.WINONA_TOOLBOX = "I keep everything I need on me."
ACTIONFAIL.WINONATOOLBOX = "As if I would need anything from there."
DESCRIBE.WINONA_CATAPULT_ITEM_UM = "It runs on modern technology, unfortunately."
DESCRIBE.WINONA_SPOTLIGHT_ITEM_UM = "It's so much better without that eletrical buzzing."
DESCRIBE.WINONA_BATTERY_LOW_ITEM_UM = "I'm not much of an electronics person."
...
DESCRIBE.EYEOFTERROR_MINI_GROUNDED_ALLY = "It needs time to rest."
...
"It's from another timeline, how did you get into this one?"
