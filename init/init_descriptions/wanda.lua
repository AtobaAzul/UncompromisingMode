...
--	[ 		Wanda Descriptions		]   --
    ...
    ANNOUNCE.ANNOUNCE_ACIDRAIN = {
        "This rain is not normal, watch out!",
        "Ow! That stings!",
	...
	ANNOUNCE.ANNOUNCE_DETACH_BUFF_CALIFORNIAKING = "I feel like rewinding to a point before I ate that."
    ...
    DESCRIBE.COOKEDMONSTERSMALLMEAT = "Either I rushed cooking it or it is still just that bad."
    DESCRIBE.MONSTERSMALLMEAT_DRIED = "Hopefully it has gotten better after all this time."
    ...
    DESCRIBE.GASMASK = "I never really wore masks before, I wonder how I would look..."
	...
	DESCRIBE.APHID = "They have such a short lifespan, yet they waste it eating twigs..."
