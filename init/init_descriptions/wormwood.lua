...
--	[ 		Wormwood Descriptions		]	--
    ...
    DESCRIBE.MONSTERMORSEL = "Not angry now"
    DESCRIBE.COOKEDMONSTERMORSEL = "Weird belly stuff"
    DESCRIBE.MONSTERMORSEL_DRIED = "Chewy!"
	...
	DESCRIBE.ICEBOOMERANG = "Cold Digger Tail?"
