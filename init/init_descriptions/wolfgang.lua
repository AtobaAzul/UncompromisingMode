...
--	[ 		Wolfgang Descriptions		]	--
	...
	--Content Creators
	DESCRIBE.CCTRINKET_DON = "\"Don's\"... Smudged words!"
	DESCRIBE.CCTRINKET_JAZZY = "Is Jazzy horn!"
	DESCRIBE.CCTRINKET_FREDDO = "Tape Box. Is named \"Freddo\"."		
	--Content Creators
    ...
    DESCRIBE.BLUEBERRYPANCAKES = "Is good breakfast."
    DESCRIBE.SIMPSALAD = "Is diet food."
    DESCRIBE.BEEFALOWINGS = "Haha! Is mighty food!"
    ANNOUNCE.ANNOUNCE_ATTACH_BUFF_KNOCKBACKIMMUNE = "Wolfgang giant! Won't move!"
    ANNOUNCE.ANNOUNCE_DETACH_BUFF_KNOCKBACKIMMUNE = "Wolfgang w-won't move!"
	DESCRIBE.WIDOWSHEAD = "Keep away from Wolfgang! Agh!"
