...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    "Rain is burning Wolfgang's muscles!", "Rain is biting Wolfgang!",
...
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_VETCURSE = "Muscles... feel weaker..."
...
-- CaliforniaKing
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_CALIFORNIAKING = "I AM.... mighty?"
ANNOUNCE.ANNOUNCE_DETACH_BUFF_CALIFORNIAKING = "Wolfgang feel better now."
DESCRIBE.CALIFORNIAKING = "I will defeat drink!"
-- CaliforniaKing
...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    "Wolfgang not like scary screeches!", "Scary monster angry!", "Fire! Fire!"
}
...
DESCRIBE.VET_SKULL = "Bone head is tiny!"
DESCRIBE.UM_BOSS_SOUL = "Is strong soul."
DESCRIBE.UM_DARK_VESTIGES = "It stinks."
DESCRIBE.UM_VOXOLOPHONE = "Little box is creepy."

DESCRIBE.UM_EXHUMER = "Wolfgang hates bones."
DESCRIBE.UM_WINGSUIT = "Wolfgang flap hard, and go far!"
DESCRIBE.UM_MOONFLY_LANTERN = "Wolfgang not need night light, but light for night is good?"
...
DESCRIBE.RICE = "Wolfgang will crush into smaller grains!"
DESCRIBE.RICE_COOKED = "Fuel for a mighty belly!"
DESCRIBE.SEAFOODPAELLA = "Make nose feel funny!"
DESCRIBE.LICELOAF = "Boring food is still mighty food!"
DESCRIBE.SUNGLASSES = "Gah! These fit bad!"

DESCRIBE.CRITTERLAB_REAL = DESCRIBE.CRITTERLAB
DESCRIBE.CRITTERLAB_REAL_BROKEN = "Wolfgang make new home out of moon rock."
...
DESCRIBE.PURPLESTEAMEDHAMS = "Is mouthwatering hamburgers."
DESCRIBE.GREENSTEAMEDHAMS = "Is mouthwatering hamburgers."
DESCRIBE.BLUEBERRYPANCAKES = "Mighty pancakes!"
DESCRIBE.DEVILSFRUITCAKE = "How can cake be evil?"
...
DESCRIBE.SPOREHOUND = "Rrrwoof! Hck!"
DESCRIBE.GLACIALHOUND = "Grwalf! Grwalf!"
...
DESCRIBE.BEARGERCLAW = "Now Wolfgang like mighty bear!"
...
ANNOUNCE.ANNOUNCE_ATTACH_BUFF_HYPERCOURAGE = "Mind is strong!"
ANNOUNCE.ANNOUNCE_DETACH_BUFF_HYPERCOURAGE = "Wolfgang scared again..."
-- StantonStuff
...
DESCRIBE.WINONA_CATAPULT_ITEM_UM = "For lifting?"
DESCRIBE.WINONA_SPOTLIGHT_ITEM_UM = "For lifting?"
...
DESCRIBE.UM_OCUPUS_EYE = "Wolfgang suggests not going over there."
DESCRIBE.UM_OCUPUS_EYETACLE = "Wolfgang doesn't like being watched. Will smash!"
DESCRIBE.UM_OCUPUS_TENTACLE = "Big grabbing monster!"
DESCRIBE.UM_OCUPUS_BEAK = "Stop yelling at Wolfgang!"
DESCRIBE.BEAKBASHER = "Heavy beak is good hammer head."
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "Wolfgang doesn't like eye tree."

DESCRIBE.ARMOR_REED_UM = "Smooth and hollow tube suit."
DESCRIBE.ARMOR_SHARKSUIT_UM = "Rock solid! Hah!"
DESCRIBE.ROCKJAWLEATHER = "Very tough, It is hard to rip apart!"

DESCRIBE.EYEOFTERROR_MINI_ALLY = "Will watch after scary little eye friends!"
