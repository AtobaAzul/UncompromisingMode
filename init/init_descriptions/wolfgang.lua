...
--	[ 		Wolfgang Descriptions		]	--
	...
	ANNOUNCE.ANNOUNCE_ATTACH_BUFF_KNOCKBACKIMMUNE = "Wolfgang is too mighty for push!"
	ANNOUNCE.ANNOUNCE_DETACH_BUFF_KNOCKBACKIMMUNE = "Mighty Wolfgang will not be moved!"
	...
	DESCRIBE.UM_BEAR_TRAP_EQUIPPABLE_TOOTH = "Large metal teeth, with very strong grip."
	DESCRIBE.UM_BEAR_TRAP_EQUIPPABLE_GOLD = "Large metal teeth, with very strong grip."
	...
	ANNOUNCE.ANNOUNCE_ATTACH_BUFF_LARGEHUNGERSLOW = "Now boogers in Wolfgang! Oh ho ho!"
	ANNOUNCE.ANNOUNCE_DETACH_BUFF_LARGEHUNGERSLOW = ""
	DESCRIBE.BOOK_RAIN_UM = "Doesn't Wolfgang have better things to do that read book about rain?"
