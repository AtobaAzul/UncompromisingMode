...
--	[ 		Wurt Descriptions		]	--
	...
	--Content Creators
	DESCRIBE.CCTRINKET_DON = "\"D...Don...\" Flurgh!"
	DESCRIBE.CCTRINKET_JAZZY = "Jazzy sounds, florp!"
	DESCRIBE.CCTRINKET_FREDDO = "\"Free-doh\"? What word mean?"		
	--Content Creators
    ...
    DESCRIBE.BLUEBERRYPANCAKES = "Blue berry good!"
    DESCRIBE.SIMPSALAD = "Is better than meat!"
    DESCRIBE.BEEFALOWINGS = "Poor beefalo..."
    ANNOUNCE.ANNOUNCE_ATTACH_BUFF_KNOCKBACKIMMUNE = "Hrrngh, scales tough!"
    ANNOUNCE.ANNOUNCE_DETACH_BUFF_KNOCKBACKIMMUNE = "Feel weak..."
	DESCRIBE.WIDOWSHEAD = "Scary!!"
