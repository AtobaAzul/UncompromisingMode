...
ANNOUNCE.ANNOUNCE_ACIDRAIN = {
    "Ow! Burny rain!", "Hurting! Rain hurting!", "Ow! This rain bad!"
}
...
ANNOUNCE.ANNOUNCE_FIREFALL = {
    "Bllrgh, is scary!", "Anty angry!", "Groundy fire! Florp!"
}
ANNOUNCE.ANNOUNCE_ROOTING = "Stuck!"
ANNOUNCE.ANNOUNCE_SNOWSTORM = "Brrr... chilly wind. More snow coming soon?"
ANNOUNCE.SHADOWTALKER = {
    "DO SCALE-LESS TRUST ME?", "WHERE... FROM...",
    "WHY... HORNS? AM... MERMFOLK?", "MOUTH IN SKY...", "IS STORY... TRUE?",
    "WHAT IF WEBBY BOY NOT FRIEND?", "NOTHING FEEL RIGHT...",
    "DO ANYONE EVEN LIKE MERMFOLK?", "WILL SCALE-LESS STILL HELP ME?"
}
...
DESCRIBE.VET_SKULL = "Oh, deadfolk?"
DESCRIBE.UM_BOSS_SOUL = "Bad soul..."
DESCRIBE.UM_DARK_VESTIGES = "Who-man-i-ty?"
DESCRIBE.UM_VOXOLOPHONE = "Metally box talk to us?"

DESCRIBE.UM_EXHUMER = "Glorp! Scary shovel..."
DESCRIBE.UM_WINGSUIT = "Scaled-folk like bird-folk now!"
DESCRIBE.UM_MOONFLY_LANTERN = "Ooh, glowy!"
...
DESCRIBE.PURPLESTEAMEDHAMS = "Glurgh... how you even \"steam\" ham?"
DESCRIBE.GREENSTEAMEDHAMS = "Glurgh... how you even \"steam\" ham?"
DESCRIBE.BLUEBERRYPANCAKES = "Fluffy and juicy!"
DESCRIBE.DEVILSFRUITCAKE = "It has juicy sacks inside!"
...
DESCRIBE.MOONMAW_LAVAE = "No! No stabbing!"
...
DESCRIBE.OCUPUS_TENTACLE = "Not spiky this time."
DESCRIBE.OCUPUS_TENTACLE_EYE = "Eye ball, florp."
DESCRIBE.OCUPUS_TENTACLE_COOKED = "No! Not food."
DESCRIBE.UM_OCUPUS_EYE = "Lots of eye balls."
DESCRIBE.UM_OCUPUS_EYETACLE = "Remove eye balls for let go."
DESCRIBE.UM_OCUPUS_TENTACLE = "Didn't know it was out here too!"
DESCRIBE.UM_OCUPUS_BEAK = "Its screech hurts."
DESCRIBE.BEAKBASHER = "Break more stuff! Haha!"
DESCRIBE.HOUNDIOUS_OBSERVIOUS = "It tells us when the doggies come."
...
DESCRIBE.EYEOFTERROR_MINI_ALLY = "Glurp... No durians for you! All for me!"
...
DESCRIBE.SUNKENCHEST_ROYAL_RANDOM = "Need this. Bring to king."
...
DESCRIBE.SLINGSHOT_MATILDA = "Makes funny sounds!"
DESCRIBE.SLINGSHOT_GNASHER = "Bad stuff makes bad stuff!"
...
DESCRIBE.BAGOFMARBLES = "Oooh, like little fish eggs!"
...
-- Pyre Nettle stuff
DESCRIBE.UM_PYRE_NETTLES = "Still taste like burning!"
DESCRIBE.UM_SMOLDER_SPORE = "F-flurpt..."
ANNOUNCE.ANNOUNCE_SMOLDER_SPORE_EATEN = {
	"KNEW IT WOULD HAPPEN, BUT IT LOOK SO GOOD!!",
	"REGRET EVERYTHING!!"
}
