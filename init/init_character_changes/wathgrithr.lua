...
TUNING.DSTU.WATHGRITHR_BASE_BATTLEBORN_MULT = 0.33
...
TUNING.SPEAR_WATHGRITHR_LIGHTNING_USES = 150 * 1.5
TUNING.SPEAR_WATHGRITHR_LIGHTNING_CHARGED_USES = 200 * 1.3
...
TUNING.DSTU.WATHGRITHR_SHADOW_BATTLEBORN_MULT = 0.66
