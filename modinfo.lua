...
description =
[[
󰀔 [ Version 1.1.19: "Face Your Fears" ]
...
version = "Face Your Fears v1.1.19"
...
------------------------------
...

	{
		...
		hover = "Loot no longer gets destroyed when a mob is burnt to death. Mobs will explode on death, dealing damage and lighting things on fire, based on loot dropped.",
		options =
		{
...
--	BinaryConfig("wolfgang", "Improved/Balanced Wolfgang", "Wolfgang gains new perks and downsides. Read the patch notes included in the mod folder or workshop for details.", false),
	...
	BinaryConfig("winonawackycats", "Experimental Winona Catapults", "Catapults no longer regenerate, have reduced health, and deal 34 AOE damage.", false),
	...
	BinaryConfig("lunar grimoire", "Wickerbottom: Lunar Grimoire", "\"Lunar Grimoire\" now mutates things around you.", true),
	BinaryConfig("apicultural notes", "Wickerbottom: Apicultural Notes", "\"Apicultural Notes\" now fills Bee Boxes around you to max.", true),
...
------------------------------
	BinaryConfig("hoodedforest", "Hooded Forest", "Hooded Forest replaces the Moon Base forest, with brand new things to explore, including a new boss!", true),
	{
		name = "ghostwalrus",
		label = "Rusty Traps",
		hover = "The MacTusks forgot to pick up their traps and left them to rust.",
		options =
		{
...
------------------------------
	{
		...
		hover = "Minimum grace period, during which Rats are unable to invade!",
		options =
		{
...
-----------------------------
	...
	},
	{
		...
		options =
		{
			...
			{description = "On (Backpack-like)", data = 2, hover = "Items with pockets act like backpacks. However, they can't be stored in the inventory."},
	...
	BinaryConfig("uncool_chester", "Thermal Stone Snow Chester Nerf", "Snow Chester will no longer freeze Thermal Stones.", true),
	{
		...
		hover = "Controls how electrical weapons (Bug Zapper and Morning Star) behave.",
		options =
		{
			{description = "Electrical Mishap", data = 1, hover = "Weapons can be charged with Lightning and Generators."},
			{description = "Classic", data = 2, hover = "Weapons can be refueled with certain electricity-related items." },
			{description = "Off", data = 0},
		},
		default = 1,
	},
...
-----------------------------
	...
	},
	{
		...
		hover = "Hooded Widow's health can be lowered to better match a singleplayer experience.",
		options =
		{
	...
	},
	{
		...
		hover = "Wilting Dragonfly's health can be lowered to better match a singleplayer experience.",
		options =
		{
	...
	},
	{
		...
		hover = "Twins of Terror's health can be lowered to better match a singleplayer experience.",
		options =
		{
