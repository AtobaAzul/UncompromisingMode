...
configuration_options = {
    ...
    BinaryConfig("winona_portables", "Winona - Portable Structures",
        "Makes Winona's structures portable and changes what can be stored into Winona's Toolbox depending if it's enabled or not.", false),
