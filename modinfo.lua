...
description = [[
󰀔 [ Version 1.2.3.2: "Face Your Fears" ]
...
version = "Face Your Fears v1.2.3.2"
...
configuration_options = {
    ...
    {name = "wortox", label = "Wortox", hover = "Wortox has different settings that change his characteristics.", options = {{description = "SHOT", data = "SHOT", hover = "Souls heal over time."}, {description = "Classic", data = "UMNERF", hover = "Less soul sources, less max health."}, {description = "Apollo\'s", data = "APOLLO", hover = "Souls heal less and overtime. Sanity loss from eating souls increased.\nIncreased map hop range. Food penalty increased to 75%."}, {description = "Vanilla", data = "off"}}, default = "UMNERF"},
