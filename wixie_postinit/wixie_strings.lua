...
--	[ 		Wixie Descriptions		]	--
    ...
    ANNOUNCE.ANNOUNCE_RATRAID_OVER = "My things! My beautiful things! Come back here!"
    ANNOUNCE.ANNOUNCE_ACIDRAIN = {
        "Ow! Stop the pollution!",
        "I thought 'water never hurt anyone'!",
	...
	--CaliforniaKing
	ANNOUNCE.ANNOUNCE_ATTACH_BUFF_CALIFORNIAKING = "That hit my stomach like a truck..."
    ...
    DESCRIBE.COOKEDMONSTERSMALLMEAT = "I've smoked out the monster. And most of the meat too..."
	...
	ANNOUNCE.ANNOUNCE_HAYFEVER_OFF = "*sniff* *sniff* Aahhh, finally, my allergies are gone!"
	ANNOUNCE.ANNOUNCE_SNOWSTORM = "Board up the windows, there is definetly a storm coming!"
	ANNOUNCE.ANNOUNCE_FIREFALL = {
		"Hey, this shouldn't be a feature!",
		"Go tell a dev, you jerk!",
		"I thought we removed this!",
	}
	ANNOUNCE.ANNOUNCE_ROOTING = "Hands off! HANDS OFF!!"
	ANNOUNCE.SHADOWTALKER = {
        "MOM WORKS ALL DAY, SHE WHITTLES AWAY",
	...
	DESCRIBE.UM_BEAR_TRAP_EQUIPPABLE_GOLD = "It's shiny bait and a trap, all in one!"
	...
	DESCRIBE.MINOTAUR_BOULDER_BIG = "Hey, Klei! Why'd you have to go and copy my rework, Huh? HUH?!"
	DESCRIBE.SNOWBALL_THROWABLE = "No one can match my aim!"
	DESCRIBE.VETERANSHRINE = "Hey, you uh, have goop coming out of your eyes. And nose... and mouth..."
	...
	DESCRIBE.DISEASECUREBOMB = "Why fix what's broke, when you can break it even more?"
	DESCRIBE.SHROOM_SKIN_FRAGMENT = "I could stitch some of these together, I guess."
	...
	DESCRIBE.GIANT_TREE = "It's tall. And imposing. And... I don't like looking at it."
	...
	DESCRIBE.GIANT_TREE_INFESTED = "What kind of weirdo would live in a place like that?"
	...
	ANNOUNCE.ANNOUNCE_DETACH_BUFF_KNOCKBACKIMMUNE = "Ah, well... I still can't be pushed around!"
	...
	DESCRIBE.DRIFTWOODFISHINGROD = "It comes from the sea, so it will work better. Right?"
	...
	DESCRIBE.WINONA_UPGRADEKIT_ELECTRICAL = "Neat. I don't know what it is, but it's neat!"
...
DESCRIBE.SUNKENCHEST_ROYAL_RAINBOW = DESCRIBE.SUNKENCHEST_ROYAL_RANDOM
	...
	general_scripts.WIXIE1 = {
		...
		lines = {
			...
			{roles = {"wixie"},     duration = 4.0, line = STRINGS.STAGEACTOR.WIXIE1[6], anim = "idle_walter"},
			{roles = {"wixie"},     duration = 3.0, line = STRINGS.STAGEACTOR.WIXIE1[7]},
			{roles = {"wixie"},     duration = 1.5, line = STRINGS.STAGEACTOR.WIXIE1[8], anim = "emote_jumpcheer"},
		}
	}
		--[[
